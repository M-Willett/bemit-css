        ...
        return (
            <aside className={'c-sidebar c-sidebar--fixed u-scrollable u-br'}>
                <div className={'c-sidebar__inner u-p'}>
                    {/* Settings */}
                    <a className={'c-sidebar__list__link c-sidebar__list__link--parent o-block u-mb--xs u-font--bold u-mt--md u-pl--rg'} href={'#section_settings'}>Settings</a>
                    ...
                    {/* Resets */}
                    <a className={'c-sidebar__list__link c-sidebar__list__link--parent o-block u-mb--xs u-font--bold u-mt--xl u-pl--rg'} href={'#section_resets'}>Resets</a>
                    ...
                    {/* Elements */}
                    <a className={'c-sidebar__list__link c-sidebar__list__link--parent o-block u-mb--xs u-font--bold u-mt--xl u-pl--rg'} href={'#section_elements'}>Elements</a>
                    ...
                    {/* Objects */}
                    <a className={'c-sidebar__list__link c-sidebar__list__link--parent o-block u-mb--xs u-font--bold u-mt--xl u-pl--rg'} href={'#section_objects'}>Objects</a>
                    <a className={'c-sidebar__list__link o-block u-mb--xs u-pl--rg'} href={'#object_block'}>Block</a>
                    <a className={'c-sidebar__list__link o-block u-mb--xs u-pl--rg'} href={'#object_flex'}>Flex</a>
                    <a className={'c-sidebar__list__link o-block u-mb--xs u-pl--rg'} href={'#object_grid'}>Grid</a>
                    ...
                    {/* Components */}
                    <a className={'c-sidebar__list__link c-sidebar__list__link--parent o-block u-mb--xs u-font--bold u-mt--xl u-pl--rg'} href={'#section_components'}>Components</a>
                    ...
                    {/* Utilities */}
                    <a className={'c-sidebar__list__link c-sidebar__list__link--parent o-block u-mb--xs u-font--bold u-mt--xl u-pl--rg'} href={'#section_utilities'}>Utilities</a>
