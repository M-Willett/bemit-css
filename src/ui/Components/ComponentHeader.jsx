...
export default class ComponentHeader extends React.Component {
    render(){
        return (
            <div id={'component_header'} className={'id-component__wrapper o-block u-mt--xxl u-mb--xxl'}>
                ...
                <p className={'u-mb--lg'}>Please note that the <span className={'c-code c-code--inline'}>c-header</span> base class is always required. Modifiers should be appended to customise or redefine the base header component.</p>
